    ...
    return (
        <section id="auth-flow" className="scroll-mt-24 mb-16">
            <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-2xl font-bold text-zinc-900">Authentication Flow</h2>
            </div>
            <div className="prose prose-zinc max-w-none text-zinc-600 leading-relaxed">
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-8">
                    <div className="p-4 bg-zinc-50 border border-zinc-200/80 rounded-xl">
                        <div className="text-xs font-bold text-blue-600 uppercase tracking-wider mb-1">SSO Token</div>
                        <p className="text-xs text-zinc-600">A short-lived JWT signed by your backend using the shared SSO secret to identify users.</p>
                    </div>
                    <div className="p-4 bg-zinc-50 border border-zinc-200/80 rounded-xl">
                        <div className="text-xs font-bold text-blue-600 uppercase tracking-wider mb-1">Access Token (AT)</div>
                        <p className="text-xs text-zinc-600">Sent with API requests to authenticate document and folder requests directly.</p>
                    </div>
                    <div className="p-4 bg-zinc-50 border border-zinc-200/80 rounded-xl">
                        <div className="text-xs font-bold text-blue-600 uppercase tracking-wider mb-1">Refresh Token (RT)</div>
                        <p className="text-xs text-zinc-600">Long-term credential stored on the user record to seamlessly renew access tokens.</p>
                    </div>
                </div>

                <h3 className="text-lg font-bold text-zinc-900 mt-6 mb-2">Step 1 — Generate an SSO Token</h3>
                ...
                <h3 className="text-lg font-bold text-zinc-900 mt-6 mb-2">Step 2 — Exchange the SSO Token</h3>
                <p className="text-sm text-zinc-600">
                ...
                <h3 className="text-lg font-bold text-zinc-900 mt-6 mb-2">Saving Tokens to Your Database</h3>
                <p className="text-sm text-zinc-600">
                ...
                <div className="my-6 p-4 rounded-xl bg-amber-50 border border-amber-200 text-amber-900 flex gap-3 text-sm">
