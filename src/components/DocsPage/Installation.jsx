    ...
    return (
        <section id="installation" className="scroll-mt-24 mb-16">
            <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-2xl font-bold text-zinc-900">Installation & Initialization</h2>
            </div>
            <div className="prose prose-zinc max-w-none text-zinc-600 leading-relaxed">
                ...
                <h4 className="text-sm font-semibold text-zinc-700 uppercase tracking-wider mb-2">Install via NPM</h4>
                <CodeBlock code="npm install doc-center-sdk" language="bash" />

                <h4 className="text-sm font-semibold text-zinc-700 uppercase tracking-wider mt-6 mb-2">Initialize the SDK</h4>
