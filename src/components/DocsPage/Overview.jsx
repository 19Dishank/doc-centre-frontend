            ...
            <div className="prose prose-zinc max-w-none text-zinc-600 leading-relaxed">
                ...
                <div className="grid sm:grid-cols-2 gap-4 mt-6">
                    {[
                        ...
                        <div key={index} className="p-4 bg-white rounded-xl border border-zinc-200/80 shadow-sm flex flex-col gap-1">
                            <span className="font-semibold text-zinc-900 text-sm flex items-center gap-2">
                                <span className="size-1.5 rounded-full bg-blue-500"></span>
                                {feat.title}
                            </span>
                            <span className="text-xs text-zinc-500">{feat.desc}</span>
                        </div>
                    ))}
                </div>
            </div>
