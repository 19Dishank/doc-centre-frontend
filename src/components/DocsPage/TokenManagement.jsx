    ...
    return (
        <section id="token-management" className="scroll-mt-24 mb-16">
            <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">Token Management & Session Helper</h2>
            </div>
            <div className="prose prose-zinc max-w-none text-zinc-600 dark:text-zinc-400 leading-relaxed">
                <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100 mb-2">Restoring a Session</h3>
                ...
                <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100 mt-6 mb-2"><code>ensureSdkSession()</code> Helper</h3>
                <p className="text-sm text-zinc-600 dark:text-zinc-400">
                ...
                <CodeBlock
                    ...
                    language="javascript"
                />
                <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-xl border border-zinc-200/80 dark:border-zinc-800 my-4">
                    <span className="block text-xs font-semibold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-2">How it works:</span>
                    <ol className="list-decimal pl-5 text-sm text-zinc-600 dark:text-zinc-400 space-y-1.5">
                ...
                <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100 mt-6 mb-2">Automatic Refresh Token Flow</h3>
                <p className="text-sm text-zinc-600 dark:text-zinc-400">
                ...
                <div className="my-6 p-4 rounded-xl bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900/50 text-blue-900 dark:text-blue-200 flex gap-3 text-sm">
                ...
                <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100 mt-6 mb-2">Token Utility Methods</h3>
