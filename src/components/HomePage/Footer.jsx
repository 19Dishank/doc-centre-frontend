...
const Footer = () => {
    ...
    return (
        <footer className="bg-white border-t border-zinc-200 w-full mt-auto">
            <div className="max-w-360 mx-auto px-6 md:px-8 py-12 md:py-16">
                <div className="flex flex-col md:flex-row justify-between gap-10 mb-12">
                    ...
                    <div className="flex flex-col gap-4 max-w-sm">
                        ...
                        <p className="text-zinc-400 text-sm leading-relaxed">
                            The modern document management platform for teams that care about organization, security, and speed.
                        </p>
                    ...
                    <div className="flex flex-wrap gap-12 md:gap-20 lg:gap-24">
                        {Object.entries(links).map(([group, items]) => (
                            <div key={group} className="flex flex-col gap-3 min-w-30">
