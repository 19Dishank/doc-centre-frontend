    ...
    return (
        <section className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-12">
            <div className="flex flex-col gap-6 text-center lg:text-left items-center lg:items-start order-2 lg:order-1">
                ...
                <p className="leading-relaxed text-[#71717b] dark:text-zinc-400 text-base md:text-lg max-w-125 lg:max-w-none">
                ...
                <div className="flex flex-col sm:flex-row pt-4 items-center gap-4 lg:gap-6">
                    <div className="-space-x-2 flex">
                        {[1, 2, 3, 4].map((_, i) => (
                            <div key={i} className={`size-9 rounded-full border-white dark:border-zinc-950 border-2 border-solid ${
                    ...
                    <div className="flex flex-col items-center lg:items-start">
                        <div className="flex items-center gap-1">
                            ...
                            <span className="font-bold text-sm ml-1 text-zinc-900 dark:text-zinc-100">4.9</span>
                        </div>
                        <span className="text-[#71717b] dark:text-zinc-400 text-xs leading-4">Trusted by 12,000+ teams worldwide</span>
                    </div>
                </div>
            </div>

            <div className="relative shadow-2xl rounded-2xl border-zinc-200 dark:border-zinc-800 border border-solid overflow-hidden order-1 lg:order-2 group">
                <img
                ...
                <div className="absolute inset-x-4 sm:inset-x-6 bottom-4 sm:bottom-6">
                    <Card className="backdrop-blur-md bg-white/90 dark:bg-zinc-900/90 p-3 sm:p-4 border-none shadow-xl">
                        <CardContent className="flex p-0 justify-between items-center gap-3">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col min-w-0">
                                    <span className="font-semibold text-sm truncate text-zinc-900 dark:text-zinc-100">Q4-Strategy.pdf</span>
                                    <span className="text-[#71717b] dark:text-zinc-400 text-[10px] sm:text-xs leading-tight truncate">
