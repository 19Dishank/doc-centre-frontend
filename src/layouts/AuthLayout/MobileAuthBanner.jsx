      ...
      <div className="relative z-10 flex items-center justify-between h-full px-5 sm:px-8 py-5 sm:py-6 gap-4">
        ...
        <div className="flex flex-col gap-3 flex-1 min-w-0">
          <div className="shrink-0">
            {isTenant ? (
              <div className="inline-flex items-center gap-2.5 bg-white/15 backdrop-blur-sm rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 border border-white/20">
                <div className="shrink-0 mobile-company-logo-wrap">
                  <CompanyLogo slug={slug} />
                </div>
                <style>{`.mobile-company-logo-wrap img { width: auto !important; max-width: 90px !important; max-height: 32px !important; object-fit: contain; display: block; filter: brightness(0) invert(1); }`}</style>
